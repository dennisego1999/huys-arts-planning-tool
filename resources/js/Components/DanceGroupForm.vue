    ...
    <div class="flex flex-col justify-between items-start gap-10">
        ...
        <form class="flex-1 flex flex-col gap-6 w-full" @submit.prevent>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-2 flex flex-col gap-6 justify-center rounded-lg border border-dashed border-gray-900/25 p-6">
                        ...
                        <div v-if="dgForm.image && dgForm.image.original_url" class="mt-2">
                            <img :src="dgForm.image.original_url" alt="dance group image" class="w-full aspect-video object-cover">
                        </div>
            ...
            <div class="sm:col-span-full flex flex-col gap-6">
                ...
                <ul v-if="dgForm.members.length !== 0" role="list" class="mx-auto grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <li v-for="member in dgForm.members" :key="member.name" class="relative flex flex-col justify-center items-center p-8 bg-gray-100 rounded-md">
