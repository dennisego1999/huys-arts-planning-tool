...
<template>
	<nav v-if="hasMultiplePages" class="pagination flex justify-center items-center gap-4 w-full mt-4 lg:mt-8">
		<Link
			...
			:class="{
				'inline-flex items-center border-t-2 border-fpb-primary-200 px-4 pt-4 text-sm font-bold text-fpb-primary-200':
					link.active,
				'inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-dark hover:border-fpb-primary-100 hover:text-fpb-primary-100':
					!link.active
			}"
		>
