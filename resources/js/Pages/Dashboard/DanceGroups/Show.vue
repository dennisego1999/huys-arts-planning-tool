		...
		<div class="flex flex-col justify-between items-start gap-10">
			...
			<div class="flex justify-between items-center gap-6 w-full">
				...
				<div class="flex-1">
					...
					>
						<PhotoIcon v-if="!group.image" class="mx-auto h-12 w-12 text-white" aria-hidden="true" />
			...
			<div class="bg-white py-32">
				<div class="flex flex-col gap-6 mx-auto text-center">
					...
					<ul
						...
						role="list"
						class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3"
					>
