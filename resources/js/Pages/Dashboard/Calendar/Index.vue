        ...
        <div class="flex h-full flex-col">
            <header class="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
                ...
                <div class="flex items-center">
                    <div class="relative flex items-center rounded-md border border-gray-300 bg-white shadow-sm md:items-stretch overflow-hidden">
                        <Link
                        ...
                        <div class="-mr-px hidden grid-cols-7 divide-x divide-gray-100 border-r border-gray-100 text-sm leading-6 text-gray-500 sm:grid">
                            ...
                            >
                                <div class="flex items-center justify-center gap-1 font-semibold">
                                    ...
                                    <p
                                        :class="{'grid place-content-center h-8 w-8 rounded-full bg-indigo-600 text-white': date.is_current}"
                                    >
                                        {{ date.day_number }}
                                    </p>
                                </div>
